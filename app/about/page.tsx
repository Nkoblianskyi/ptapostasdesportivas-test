      ...
      <div className="min-h-screen bg-white">
        <div className="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
          <div className="text-center mb-12 pb-8 border-b-4 border-porto-gold">
            <h1 className="font-serif text-4xl md:text-5xl font-bold text-gray-900 mb-4">Sobre Nós</h1>
            <h2 className="font-serif text-2xl md:text-3xl font-semibold text-porto-green mb-4">
              ptapostasdesportivas.com
            </h2>
          ...
          <div className="space-y-10">
            <section className="bg-white rounded-lg p-8 border-l-4 border-porto-green">
              <h3 className="font-serif text-2xl font-bold text-gray-900 mb-4">A Nossa Missão</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
                Na ptapostasdesportivas.com, a nossa missão é fornecer aos apostadores portugueses informações precisas
                e atualizadas sobre os melhores sites de apostas desportivas disponíveis no mercado nacional.
            ...
            <section className="bg-white rounded-lg p-8 border-l-4 border-porto-gold">
              <h3 className="font-serif text-2xl font-bold text-gray-900 mb-4">Análises Independentes</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section className="bg-white rounded-lg p-8 border-l-4 border-porto-green">
              <h3 className="font-serif text-2xl font-bold text-gray-900 mb-4">A Nossa Metodologia de Classificação</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-lg border-2 border-porto-green/20">
                  <h4 className="font-serif text-lg font-semibold mb-3 text-porto-green">Licenciamento e Segurança</h4>
                ...
                <div className="bg-white p-6 rounded-lg border-2 border-porto-green/20">
                  <h4 className="font-serif text-lg font-semibold mb-3 text-porto-green">
                    Ofertas de Bónus e Promoções
                  </h4>
                  <p className="text-gray-700 text-sm leading-relaxed">
                ...
                <div className="bg-white p-6 rounded-lg border-2 border-porto-green/20">
                  <h4 className="font-serif text-lg font-semibold mb-3 text-porto-green">Experiência do Utilizador</h4>
                  <p className="text-gray-700 text-sm leading-relaxed">
                ...
                <div className="bg-white p-6 rounded-lg border-2 border-porto-green/20">
                  <h4 className="font-serif text-lg font-semibold mb-3 text-porto-green">Mercados de Apostas e Odds</h4>
                  <p className="text-gray-700 text-sm leading-relaxed">
                ...
                <div className="bg-white p-6 rounded-lg border-2 border-porto-green/20">
                  <h4 className="font-serif text-lg font-semibold mb-3 text-porto-green">Apoio ao Cliente</h4>
                  <p className="text-gray-700 text-sm leading-relaxed">
            ...
            <section className="bg-amber-50/30 rounded-lg p-8 border-2 border-porto-gold">
              <h3 className="font-serif text-2xl font-bold text-gray-900 mb-4">O Nosso Sistema de Pontuação</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <p className="text-porto-green font-semibold text-lg">
                Padrão de Excelência: Apenas os melhores sites fazem parte da nossa seleção
              </p>
            </section>

            <section className="bg-white rounded-lg p-8 border-l-4 border-porto-gold">
              <h3 className="font-serif text-2xl font-bold text-gray-900 mb-4">Divulgação de Afiliação</h3>
              <p className="text-gray-700 leading-relaxed">
                A ptapostasdesportivas.com é financiada através de parcerias de afiliação com operadores de apostas.
            ...
            <section className="bg-red-50 border-l-4 border-red-600 p-8 rounded-lg">
              <h3 className="font-serif text-2xl font-bold text-red-800 mb-4">Jogo Responsável</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section className="bg-white rounded-lg p-8 border-l-4 border-porto-green">
              <h3 className="font-serif text-2xl font-bold text-gray-900 mb-4">A Nossa Equipa</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section className="bg-white rounded-lg p-8 border-l-4 border-porto-gold">
              <h3 className="font-serif text-2xl font-bold text-gray-900 mb-4">Contacte-nos</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
                Tem questões ou sugestões? Adoraríamos ouvir de si. Contacte a nossa equipa em{" "}
                <a
                  href="mailto:info@ptapostasdesportivas.com"
                  className="text-porto-green hover:text-porto-gold font-semibold underline"
                >
                  info@ptapostasdesportivas.com
                </a>
              </p>
